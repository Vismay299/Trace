...
| 36  | GitHub ingestion, normalization, and meaningful-activity filters                  | ✅ done | 2026-05-01     | GitHub artifact fetchers, high-signal filters, normalization, idempotent chunk sync, worker processor, filter tests.            |
| 37  | GitHub auto-sync, source-aware weekly context, and Ship-to-Post triggers          | ✅ done | 2026-05-01     | Repo-selection sync enqueue, cursor-based re-sync, weekly GitHub activity context, deterministic Ship-to-Post draft queue.      |
...
| 42  | Claude Code / AI coding conversation import                                       | ✅ done | 2026-05-01     | Coding transcript auto-detection/import mode, noise-stripping normalizer, first-class `ai_coding_log` source chunks.            |
| 43  | Content calendar foundations                                                      | ✅ done | 2026-05-01     | Calendar metadata migration, CRUD APIs, `/calendar` planning UI, draft scheduling from editor and board.                        |
| 44  | Narrative-plan scheduling and Ship-to-Post draft UX                               | ✅ done | 2026-05-01     | Narrative recommendations schedule directly to calendar; Ship-to-Post drafts surface in content inbox with source traceability. |
...
| 48  | Public launch hardening, QA, and rollout                                          | 🔄 in progress |                | Beta gate, legal/data-use surfaces, launch docs, and public E2E coverage complete; real sandbox launch checklist remains.       |
